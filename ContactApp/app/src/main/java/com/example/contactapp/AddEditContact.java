            ...
            case CAMERA_PERMISSION_CODE:
                if (grantResults.length >0){
                    ...
                    if (cameraAccepted && storageAccepted){
                        ...
                        Toast.makeText(getApplicationContext(), "Camera & Stocarea au nevoie de permisiune ...", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
            ...
            case STORAGE_PERMISSION_CODE:
                if (grantResults.length >0){
                    ...
                    if (storageAccepted){
                        ...
                        Toast.makeText(getApplicationContext(), "Stocarea are nevoie de permisiune..", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == IMAGE_FROM_GALLERY_CODE) {
                ...
                Toast.makeText(getApplicationContext(), "Ceva nu a mers bine", Toast.LENGTH_SHORT).show();
            }
        }
    }
}